...
def load_data():
    ...
    with open("courses.csv") as csv_file:  # Provided Dataset
    ...
    with open("t_teachers.csv") as csv_file:  # Provided Dataset
    ...
    with open("t_studentcourses.csv") as csv_file:  # Provided Dataset
...
def print_custom_schedule(schedule):
    for day in schedule.days:
        if len(schedule.days[day]) > 0:
            ...
            print(
                Back.BLACK + Fore.WHITE + " Room No " + "  9 - 12    Morning Invigilator   2 - 5     Evening Invigilator " + Back.RESET)
            print(Back.BLACK + "                                                                         " + Back.RESET)
